...
- obtain & preprocess
- **\textcolor{blue}{visualize}** to describe
- analyze
...
\vfill
let's discuss! [\textcolor{blue}{jimi.adams@sc.edu}](mailto:jimi.adams@sc.edu)

\hfill also (SN Ethics Resource - IRBs): 

\hfill ![](img/ethics-QR.png){width=20%}
